...
storiesOf("LocalLink", module)
  .add("Accessible Internal Link", () => (
    <Content>
      <p>
        LCRF Link is just a Higher Order Component (wrapper) that returns a link component if the hasAccess is true else
        just the href text is rendered as plain text.
      </p>
      <p>
        <b>
