      ...
      <Row>
        ...
        <Col xs={12} md={12} lg={12}>
          <p style={{ fontSize: "16px" }}>
            ...
            marine life in particular from the pre-Cambrian all the way up to the Miocene (5 MYA). Feel free to navigate
            through this site and I hope you enjoy what you find.
          </p>
        </Col>
      </Row>
    </Page>
