                ...
                <Filter>
                  ...
                  <div>
                    ...
                    <select id="filterCriteria" onChange={e => filter(e.currentTarget.value, "date", "date")}>
                      <option value="">All</option>
                      <option value="2018-12-18">{formatDate("2018-12-18", "de-DE")}</option>
                      <option value="2019-02-03">{formatDate("2019-02-03", "de-DE")}</option>
                    </select>
                  </div>
                </Filter>
                <Header>
                  <HeaderCell sortAsc={true} sortKey="section" sortFunction={sort}>
                    section
                  </HeaderCell>
                  <HeaderCell sortAsc={false} sortKey="verse" sortFunction={sort}>
                    verse
                  </HeaderCell>
                  <span style={{ paddingLeft: "20px" }} />
                  <HeaderCell sortAsc={true} sortDataType="date" sortKey="date" sortFunction={sort}>
                    date
                  </HeaderCell>
