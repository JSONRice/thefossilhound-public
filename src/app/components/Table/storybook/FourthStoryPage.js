              ...
              <React.Fragment>
                ...
                {isMobile ? (
                  ...
                  <Header>
                    ...
                    <HeaderCell sortAsc={true} sortKey="verse" sortFunction={sort}>
                      verse
                    </HeaderCell>
                  ...
                  <React.Fragment key={`${r.section}-${r.verse}`}>
                    {isMobile ? (
                      <MobileRow id={index} onClick={() => expand(r.id)}>
                        ...
                        <MobileCell>
                          <span style={{ fontWeight: "bold", paddingRight: "50px" }}>text</span>
                          <span>{r.text}</span>
                        </MobileCell>
                      </MobileRow>
                    ) : (
                    ...
                    {r.expand && <DesktopRow>This is expanded for {r.name}</DesktopRow>}
                  </React.Fragment>
                ))}
              </React.Fragment>
            );
