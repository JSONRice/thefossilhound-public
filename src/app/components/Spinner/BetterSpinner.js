 ...
 * cleaner than the lcrf based spinner (wheel with spokes).
 *
 * @param size
 ...
 * @constructor
 */
export default function BetterSpinner({ size, spinnerClassName, ...props }) {
  return (
    <StyledWrapper
      {...pickGlobalHtmlAttributePropsService(props)}
      size={size}
      aria-hidden="true"
    >
